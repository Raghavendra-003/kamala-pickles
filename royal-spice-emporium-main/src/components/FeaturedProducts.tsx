...
const products = [
  { name: "Mango Pickle", price: "₹299", image: heroMango, tag: "Bestseller" },
  { name: "Gongura Pickle", price: "₹349", image: heroGongura, tag: "Popular" },
  { name: "Garlic Pickle", price: "₹329", image: heroGarlic, tag: "Spicy" },
  { name: "Lemon Pickle", price: "₹279", image: productLemon, tag: "New" },
];
    ...
    <section className="py-24 bg-cream-gradient" ref={ref}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-accent font-serif text-lg italic tracking-wider">Handpicked for You</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product, i) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="font-heading text-xl font-semibold text-foreground mb-1">{product.name}</h3>
                <p className="text-accent font-heading text-xl font-bold mb-4">{product.price}</p>
